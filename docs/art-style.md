...
Kenney / graybox / prototype meshes already in `game/art/town/` are **scaffolding**. Do not use them as style references. Do not generate more assets in that look unless the user asked for a placeholder.
