...
When the atelier ships, discard or demote `game/art/ui/creator_stub_bg.png` (and any stub wipe) so New never presents the stub as the destination creator.

## Not this ticket

Building the atelier itself (CC-1).
