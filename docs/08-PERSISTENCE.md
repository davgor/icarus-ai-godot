...
- Sanctum level, farm plots, **Arrange layout** (placed buildings, furniture, lights, ground paints), and the **home-design catalog** (player unlocks of `catalog_id`s) persist on the hub save.
